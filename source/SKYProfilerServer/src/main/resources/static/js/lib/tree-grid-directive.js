    ...
    angular
        ...
        .run([
            ...
            function ($templateCache) {
				...
				/*
				 * Copyright (c) 2009 - 2011 Software AG, Darmstadt, Germany and/or its licensors
				 *
				 */
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    "       <td class=\"col-md-4 service-tree-service-name\" title=\"{{row.branch[expandingProperty.field] || row.branch[expandingProperty]}}\"><a ng-click=\"user_clicks_branch(row.branch)\"><i ng-class=\"row.tree_icon\"\n" +
                    ...
                    "       </td>\n" +
                    "       <td class=\"col-md-2\" ng-repeat=\"col in colDefinitions\">\n" +
                ...
                return {
                    ...
                    link: function (scope, element, attrs) {
                        ...
                        on_treeData_change = function () {
                            ...
                            add_branch_to_list = function (level, branch, visible, jsonPath) {
                                ...
                                branch.level = level;
                                branch.jsonPath = jsonPath + "[?(@.sN == '" + branch.sN + "')]";
                                ...
                                if (branch.children != null) {
                                	jsonPath = jsonPath + "['children']";
                                    _ref = branch.children;
                                    _results = [];
                                    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                                        child = _ref[_i];
                                        child_visible = visible && (branch.expanded || branch.level < expand_level);
                                        var cJsonPath = jsonPath + "[" + _i + "]";
                                        _results.push(add_branch_to_list(level + 1, child, child_visible, cJsonPath));
                                    }
                                    return _results;
                                }
                            };
